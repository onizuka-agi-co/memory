...
**新規企画:**
📊 **AGI Knowledge Hub 読者エンゲージメント分析ダッシュボード**
- Issue: https://github.com/onizuka-agi-co/onizuka-agi-co/issues/28
- Priority: P1 / Size: L
- Start: 2026-05-16 / Target: 2026-05-23

**概要:**
コンテンツ生成パイプラインが安定稼働しているため、次は効果測定フェーズへ移行。X投稿のエンゲージメントデータを自動収集・可視化し、コンテンツ戦略をデータドリブン化する。

**サブタスク:**
- [ ] X API メトリクス定期収集スクリプト（Size: S）
- [ ] エンゲージメントDB設計・構築（Size: M）
- [ ] VitePress分析ダッシュボードページ（Size: M）
- [ ] 週次レポート自動生成（Size: S）
